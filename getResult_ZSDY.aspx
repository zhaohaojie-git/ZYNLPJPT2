<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="getResult_ZSDY.aspx.cs" Inherits="ZYNLPJPT.getResult_ZSDY" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>获取知识单元分数</title>
  ...
  <table id="mytable"  fit="true" data-options="fitColumns:true" style="border:none;" border="false">
    	<thead>
    		<tr>
                ...
                <th data-options="field:'zsdyfs'" width="20">知识单元分数</th>
