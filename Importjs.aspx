<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Importjs.aspx.cs" Inherits="ZYNLPJPT.Importjs" %>
...
<body class="easyui-layout">
    <form action="Importjs.aspx" method="post">
         ...
         <tbody>
            <%
                for (int i = 0; i < this.xkbh.Length; i++)
                {
                    ...
                    Response.Write("  <td><a id=\"A1\" href=\"javascript:void(0)\" class=\"easyui-linkbutton\" style=\"margin-top:10px; margin-bottom:10px;\" onclick=\"uploadClick(" + xkbh[i] + ")\" >导入</a></td>");
                    Response.Write("</tr>");
                }
