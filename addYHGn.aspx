<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addYHGn.aspx.cs" Inherits="ZYNLPJPT.addYHGn" %>
...
<head id="Head1" runat="server">
   ...
   <script type="text/javascript">
       ...
       function getSelections(yhbh) {
           ...
           $.post("processAspx/addYhGnProc.aspx", { 'gnbh': gnbh, 'yhbh': yhbh }, function (result) {
               if (result == 'False') {
